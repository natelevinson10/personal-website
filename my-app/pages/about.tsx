            ...
            <div className={styles.about}>
              ...
              <div className={styles.funFacts}>
                ...
                <ul>
                  ...
                  <li>• My favorite animal is a <strong >penguin</strong>🐧, and in a truly shocking turn of events, my favorite movie has been and always will be The Penguins of Madagascar.</li>
                </ul>
              </div>
            </div>
          </div>
