          ...
          <div className={styles.textWrapper}>
            <div className={styles.about}>
              <div className={styles.aboutText}>
                <p>
                  Hello! I am a junior at <strong>Wesleyan University</strong> pursuing a Bachelor of Arts in  Computer Science. I'm 19 years old and am from <strong>Philadelphia, PA</strong> (go birds🦅). I have a deep passion for learning and problem-solving and love collaborating with others. In terms of technical skills, I am proficient in <strong>Python</strong>  and <strong>C</strong>, and have experience with HTML/CSS, SMLNJ, and JavaScript. I am eager to engage in meaningful projects and internships, actively applying my skillset to tackle challenges and gain valuable experience.
                </p>
                <p>
